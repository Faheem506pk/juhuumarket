...
export default function Product() {
  ...
  // Check if product.images and product.highlights are defined before mapping
    ...
    <>
      ...
      <section className="product-details">
        <div className="container">
          ...
          <div id="carouselExampleIndicators3" className="carousel slide mt-5 Carousel-Desktop container" data-bs-ride="carousel">
